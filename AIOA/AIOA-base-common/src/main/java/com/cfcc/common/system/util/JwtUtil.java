package com.cfcc.common.system.util;
...
import com.cfcc.common.constant.DataBaseConstant;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws AIOAException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws AIOAException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new AIOAException("未获取到用户");
		}
		return username;
	}
