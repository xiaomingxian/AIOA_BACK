package com.cfcc.modules.system.aspect;
...
import com.cfcc.common.aspect.annotation.Dict;
...
public class DictAspect {
    ...
    // 定义切点Pointcut
    @Pointcut("execution(public * com.cfcc.modules..*.*Controller.*(..))")
    ...
    private String translateDictValue(String code, String text, String table, String key) {
        ...
        for (String k : keys) {
            ...
            if (!StringUtils.isEmpty(table)){
                ...
                tmpValue = dictService.queryDictTextByKey(code, k.trim(), MycatSchema.getSchema());
            }
