...
import com.cfcc.modules.system.entity.SysAnnouncement;
import com.cfcc.modules.system.entity.SysAnnouncementSend;
import com.cfcc.modules.system.entity.SysDict;
import com.cfcc.modules.system.entity.SysLog;
import com.cfcc.modules.system.entity.SysUser;
import com.cfcc.modules.system.mapper.SysAnnouncementMapper;
import com.cfcc.modules.system.mapper.SysAnnouncementSendMapper;
import com.cfcc.modules.system.mapper.SysLogMapper;
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new AIOAException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
