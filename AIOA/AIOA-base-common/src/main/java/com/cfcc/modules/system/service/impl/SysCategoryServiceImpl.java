...
import com.cfcc.modules.system.service.ISysCategoryService;
import com.cfcc.modules.system.entity.SysCategory;
import com.cfcc.modules.system.mapper.SysCategoryMapper;
	...
	public List<TreeSelectModel> queryListByCode(String pcode) throws AIOAException {
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list==null || list.size() ==0) {
				throw new AIOAException("该编码【"+pcode+"】不存在，请核实!");
			}
			if(list.size()>1) {
				throw new AIOAException("该编码【"+pcode+"】存在多个，请核实!");
			}
