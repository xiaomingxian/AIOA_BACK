...
public class BusFunctionPage implements Serializable {
    ...
    @ExcelCollection(name = "页面详情")
    private List<BusPageDetail> busPageDetailList ;

    private List<BusFunctionUnit> busFunctionUnit ;
    private List<BusFunctionView> busFunctionView ;
    private BusProcSet busProcSet ;
